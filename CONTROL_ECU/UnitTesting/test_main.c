...
int main(void) {
    ...
    test_print("6. Buzzer Tests\n");
    test_print("7. ADC/Pot Tests\n");
    test_print("8. Door Lock Tests\n");
    test_print("9. EEPROM Tests\n");
    ...
    switch (choice) {
        ...
        case '6': run_buzzer_tests(); break;
        case '7': run_adc_tests(); break;
        case '8': run_door_tests(); break;
        case '9': run_eeprom_tests(); break;
